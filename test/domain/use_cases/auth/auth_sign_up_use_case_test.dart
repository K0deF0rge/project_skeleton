...
import 'package:project_skeleton/domain/use_cases/auth/auth_sign_up_use_case.dart';
...
void main() {
  ...
  late AuthSignUpUseCase useCase;
  ...
  test('returns Exception when signUp fails', () async {
    when(
      () => authRepository.signUp(kValidCredentials),
    ...
    verify(() => authRepository.signUp(kValidCredentials)).called(1);
  });
